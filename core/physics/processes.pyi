...
class Process(ABC, Generic[Precision]):
    ...
    def get_LAC(self, particle: ParticleArray[Precision], material: Union[Material, MaterialArray]) -> Any: ...
    def generate_free_path(self, particle: ParticleArray[Precision], material: Union[Material, MaterialArray]) -> Any: ...
    def __call__(self, particle: ParticleArray[Precision], material: Union[Material, MaterialArray]) -> InteractionArray[Precision]: ...

class PhotoelectricEffect(Process[Precision]): ...

class CoherentScattering(Process[Precision]):
    theta_generator: Any
    def generate_theta(self, particle: ParticleArray[Precision], material: Union[Material, MaterialArray]) -> NDArray[np.float64]: ...
