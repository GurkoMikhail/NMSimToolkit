...
def compute_translation_matrix(translation: Union[NDArray[np.float64], Sequence[float]]) -> NDArray[np.float64]:
...
def compute_rotation_matrix(angles: Union[NDArray[np.float64], Sequence[float]]) -> NDArray[np.float64]:
