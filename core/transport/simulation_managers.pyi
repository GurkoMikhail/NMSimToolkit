...
class SimulationManager(mt.Thread):
    ...
    def __init__(self, source: Any, simulation_volume: Volume, propagation_manager: Optional[PropagationWithInteraction] = None, stop_time: Float = ..., particles_number: Union[int, Float] = ..., queue: Optional[Queue] = None) -> None: ...
