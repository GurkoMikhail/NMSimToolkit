...
class WoodcockVoxelVolume(WoodcockParameticVolume[Precision]):
    ...
    @property
    def voxel_size(self) -> Vector3D[Precision]: ...
    @voxel_size.setter
    def voxel_size(self, value: Vector3D[Precision]) -> None: ...
    @property
    def material(self) -> Material: ...
    @material.setter
    def material(self, value: Material) -> None: ...
    def _parametric_function(self, position: Vector3D[Precision]) -> Tuple[np.ndarray, Any]: ...
